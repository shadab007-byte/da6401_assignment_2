...
class VGG11Encoder(nn.Module):
    ...
    def __init__(self, in_channels: int = 3):
        ...
        #build five named blocks so skip connections can be extracted
    ...
    def forward(
        ...
        """
        #need pre-pool features for skip connections.
        #cach block is split into conv part and pool part.
